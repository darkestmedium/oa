...
// Plugin identifiers
static constexpr unsigned int gPluginNodeId                 = 0x6606003;
static constexpr const char   gPluginNodeName[]             = "ctrlShape";
static constexpr const char   gPluginDrawDbClassification[] = "drawdb/geometry/animation/ctrlShape";
static constexpr const char   gPluginDrawRegistrantId[]     = "ctrlShapePlugin";
static constexpr const char   gPluginSelectionMask[]        = "ctrlShapeSelection";
static constexpr const char   gPluginNodeMessagePrefix[]    = "ctrlShapeGeometryOverride: ";
