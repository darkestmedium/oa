...
// Private Data
PerlinNoise ShakeNode::__ipNoise;
...
bool ShakeNode::isPassiveOutput(const MPlug& plug) const
{
...
void ShakeNode::getCacheSetup(const MEvaluationNode& evalNode, MNodeCacheDisablingInfo& disablingInfo, MNodeCacheSetupInfo& cacheSetupInfo, MObjectArray& monitoredAttributes) const
{
